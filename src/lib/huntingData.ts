...
export const strategicOpportunities: StrategicOpportunity[] = [
  {
    ...
    tags: 60,
    quality: "Good",
    strategy: "High Success",
    description: "Excellent odds with good hunting quality"
  },
  {
    id: 2,
    state: "utah",
    ...
    quality: "Excellent",
    strategy: "High Success",
    description: "Outstanding deer hunting with high draw odds"
  },
  {
    id: 3,
    state: "wyoming",
    ...
    description: "Great entry-level hunting opportunity"
  },
  {
    id: 4,
    state: "wyoming",
    ...
    quality: "Excellent",
    strategy: "Beginner Friendly",
    description: "Best antelope hunting with nearly guaranteed draw"
  },
  {
    id: 5,
    state: "colorado",
    ...
    quality: "Good",
    strategy: "Balanced",
    description: "Good balance of odds and hunting quality"
  },
  {
    id: 6,
    state: "montana",
    ...
    quality: "Good",
    strategy: "High Success",
    description: "Great elk hunting with excellent draw odds"
  },
  {
    id: 7,
    state: "utah",
    ...
    tags: 45,
    quality: "High",
    strategy: "Archery Specialist",
    description: "Premium archery elk hunting"
  },
  {
    id: 8,
    state: "utah",
    ...
    tags: 12,
    quality: "High",
    strategy: "Second Draw",
    description: "Good backup option for second draw"
  },
  {
    id: 9,
    state: "colorado",
    ...
    tags: 25,
    quality: "Premium",
    strategy: "Trophy Hunter",
    description: "Premium unit for trophy bulls"
  },
  {
    id: 10,
    state: "wyoming",
    ...
    quality: "Premium",
    strategy: "Trophy Hunter",
    description: "World-class elk hunting unit"
  },
  {
    id: 11,
    state: "utah",
    ...
    quality: "Good",
    strategy: "Beginner Friendly",
    description: "Easy antelope hunting for beginners"
  },
  {
    id: 12,
    state: "colorado",
    ...
    quality: "High",
    strategy: "High Success",
    description: "Late season elk hunting with great odds"
  }
];
